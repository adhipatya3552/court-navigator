# SOURCES.md — Official source registry (V1)

Only primary / official sources are used as authorities. Third-party blogs, SEO legal sites, Quora and social posts are **not** authorities and were not used for any procedural claim.
...
| indiacode | India Code statute repository | Legislative Department, GoI | https://www.indiacode.nic.in | India | Read current Act text with counsel; V1 cites **no** section numbers | General guidance |
| nalsa | NALSA legal-aid information | NALSA | https://nalsa.gov.in | India | Legal-aid route for party-in-person users | General guidance |

## Key distinctions enforced in UI and content

- **General eCourts process** vs **MP-specific procedure** vs **court/registry-specific variation** are labelled separately.
- No V1 content asserts a specific MP rule number, form number, fee, limitation period or section number — anything requiring those is marked **Needs verification**.
- CrPC/BNSS transition: V1 deliberately avoids citing either code's section numbers. Users are pointed to India Code + counsel.
